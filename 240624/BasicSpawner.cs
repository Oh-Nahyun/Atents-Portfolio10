...
public class BasicSpawner : MonoBehaviour, INetworkRunnerCallbacks
{
    ...
    // INetworkRunnerCallbacks 인터페이스 함수 ------------------------------------
    ...
    {
        NetworkInputData data = new NetworkInputData(); // 우리가 만든 데이터 타입을 new 하기

        ///// 1. 인풋 매니저로 키 입력 상태 확인하는 방식?
        //if (Input.GetKey(KeyCode.W)) // 이 순간 W키가 눌려있는지 확인 (결과가 true면 W키가 눌려있다. false면 안눌려있다.)
        //{
